...
import Sliderbar from "./header/Sliderbar";
...
console.log("kkkkkkkkkkkkkkkkkkkkkkkkkkkk",itemList);
  ...
  return (
   ...
   <div className="light-two"></div>
      <div className="col-lg-4 col-md-3 col-sm-4" id="background-image">
        {/* <img className="image" src={require("../assets/")} />
        <img className="image" src={require("../assets/")} /> */}
      </div>
...
<span class="loader"></span>     
            ...
            return (
              ...
              <div className="" key={index}>
                <Card className="bg-dark ">
                  <a  href="/#" onClick={() => navigate("/product", { state: { item } })}>
      ...
      <div className="container d-flex two-images">
        <img   alt="" id="women-design" src={require("../assets/id6-banner5.jpg")} />

        <img   alt="" id="women-design" src={require("../assets/id6-banner6.jpg")} />
      </div>
      <br></br>
      <br></br>
      <br></br>
